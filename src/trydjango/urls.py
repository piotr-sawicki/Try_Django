...
urlpatterns = [
    ...
    path('contact/', pages_v.contact_view, name='contact'),
    path('products/', products_v.product_list_view, name='product-list'),
    path('product/<int:id>/', products_v.dynamic_product_detail_view, name='product-detail'),
